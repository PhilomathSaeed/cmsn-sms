...
class Ion_auth
    ...
    public function is_student($id = false)
        ...
        $student_group = $this->config->item('student_group', 'ion_auth');

        return $this->in_group($student_group, $id);
        }
    ...
    public function is_parents($id = false)
        {
        $this->ion_auth_model->trigger_events('is_parents');

        $parents_group = $this->config->item('parents_group', 'ion_auth');

        return $this->in_group($parents_group, $id);
        }

    public function is_accountant($id = false)
        {
        $this->ion_auth_model->trigger_events('is_accountant');

        $accountant_group = $this->config->item('accountant_group', 'ion_auth');

        return $this->in_group($accountant_group, $id);
        }
