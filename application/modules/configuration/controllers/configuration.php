...
class Configuration extends MX_Controller
    ...
    public function conWeeklyDay()
        ...
        if ($this->input->post('submit',TRUE)) {
            ...
            redirect('module=configuration&view=conWeeklyDay', 'refresh');
        } else {
    ...
    public function generalSetting()
        ...
        if ($this->input->post('submit',TRUE)) {
            ...
            if ($this->db->empty_table('configuration')) {
                ...
                $config['upload_path'] = './assets/uploads/schoollogo/';
                $config['allowed_types'] = 'gif|jpg|png';
                $config['max_size'] = '10000';
                $config['max_width'] = '219';
                ...
                $insertArray = array(
                    ...
                    'logo' => $this->db->escape_like_str($uploadFileInfo['file_name']),
                    'time_zone' => $this->db->escape_like_str($this->input->post('timeZone',TRUE))
                );
                $this->db->insert_string('configuration', $insertArray);
