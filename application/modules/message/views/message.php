            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="index.php?module=message&view=sendMessage" class="form-horizontal form-bordered" method="POST">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Select Group</label>
                                    <div class="col-md-6">
                                        <select onchange="selectReceiver(this.value)" class="form-control" name="receiverGroup" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select id="ajaxResult" name="receiver" class="form-control select2me" data-placeholder="Select..." required>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<script>
    function selectReceiver(str) {
        ...
        xmlhttp.open("GET", "index.php?module=message&view=ajaxSelectReciver&q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
