...
class Notice extends CI_Controller
     ...
     * 		http://example.com/index.php?module=Notice
     * 	- or -  
     * 		http://example.com/index.php?module=notice&view=<method_name>
     */
    ...
    public function addNotice()
        ...
        if ($this->input->get('submit',TRUE)) {
            ...
            $subject = $this->input->get('noticeSubject');
            $notice = $this->input->get('noticeDetails');
            ...
            if ($this->db->insert('notice_board', $noticeArray)) {
                redirect('module=notice&view=allNotice', 'refresh');
            }
        } else {
            $this->load->view('temp/header');
