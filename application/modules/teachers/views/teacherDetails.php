    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Teacher's Details <small> Information</small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="#">All Teacher Information</a>
                    </li>
                </ul>
            ...
            <div class="col-md-3">
                ...
                <ul class="ver-inline-menu tabbable margin-bottom-10">
                    <li class="detailsPicture">
                        <img alt="" class="img-responsive" src="assets/uploads/teachersPicture/<?php echo $photo; ?>">
                    </li>
                    <?php if ($this->ion_auth->is_admin()) { ?>
                        <li>

                            <a href="index.php?module=teachers&view=edit_teacher&id=<?php echo $teacherID; ?>&uid=<?php echo $userId; ?>">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#tab_1_11">
                                Educational Full Information </a>
                        </li>
                    </ul>
