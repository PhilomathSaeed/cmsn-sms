...
Class Transport extends CI_Controller
     ...
     * 		http://example.com/index.php?module=transport
     * 	- or -  
     * 		http://example.com/index.php?module=transport&view=<method_name>
     */
    ...
    public function addTransport()
        ...
        if ($this->input->post('submit',TRUE)) {
            ...
            if ($this->db->insert('transport', $routeInfoInsert)) {
                redirect('module=transport&view=allTransport', 'refresh');
            }
        } else {
