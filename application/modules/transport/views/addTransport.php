            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> Give The Information For New Transport.
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" action="index.php?module=transport&view=addTransport" method="POST">
                            <div class="form-body">
