            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" action="index.php?module=sclass&view=allClassRoutine" method="POST">
                            <div class="form-body">
                            ...
                            <div class="form-actions fluid">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn blue" name="submit" type="submit">Start</button>
