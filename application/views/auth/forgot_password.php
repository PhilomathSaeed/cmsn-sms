...
<html lang="en" >
    ...
    <head>
        ...
        <base href="http://asms.icesoftbd.com/">
    ...
    <body class="login">
        ...
        <div class="content">
            ...
            echo form_open("module=auth&view=forgot_password", $attributes); ?>
            ...
            <div class="form-actions">
                <button type="button" id="back-btn" class="btn" onclick="location.href = 'index.php?module=auth&view=login'">
