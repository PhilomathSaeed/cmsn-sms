...
<html lang="en" >
    ...
    <body class="login">
        ...
        <div class="content">
            ...
            echo form_open("module=auth&view=login", $attributes); ?>
...
<?php echo form_checkbox('remember', '1', FALSE, 'id="remember"'); ?>
            ...
            <div class="forget-password">
                <h4>Forgot your password ? <a href="index.php?module=auth&view=forgot_password" id="forget-password">click here </a></h4>
