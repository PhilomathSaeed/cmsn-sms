            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> School Information Settings
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('module=configuration&view=generalSetting', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($message)) {
                            ...
                            if (!empty($error)) {
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">School Name <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="School Name" name="schoolName" value="<?php echo $row['school_name']; ?>" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Starting Year <span class="requiredStar"> * </span></label>
                                    <div class="col-md-4">
                                        <input class="form-control" name="startingDate" id="mask_date2" type="text" value="<?php echo $row['starting_year']; ?>" required>
                                        <span class="help-block">
                                            Date Type  DD/MM/YYYY </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Headmaster Name <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="Headmaster Name" name="headmasterName" value="<?php echo $row['headmaster_name']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">School Address <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="address" rows="3" required><?php echo $row['address']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Official Phone <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="phone" placeholder="" value="<?php echo $row['phone']; ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" class="form-control" placeholder="" name="email" value="<?php echo $row['email']; ?>" required>
                                        <span class="help-block">abcd@gmail.com </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Currency <span class="requiredStar"> * </span></label>
                                    <?php
                                    $value2 = $row['currenct'];
                                    ...
                                    <div class="col-md-6">
                                        <select name="currency" class="form-control currencyConfig" required>
                                            <option value="<?php echo $row['currenct']; ?>"><?php echo $answer; ?></option>
                                ...
                                <div class="form-group last">
                                    <label class="control-label col-md-3">School Logo <span class="requiredStar"> * </span></label>
                                    <div class="col-md-9">
                                ...
                                ?>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Time Zone <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
                                        <select name="timeZone" class="form-control" required>
                                            <option value="<?php echo $row['time_zone']; ?>"> <?php echo $answer2; ?></option>
...
<?php } ?>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-6">
                                <button type="submit" class="btn green" name="submit" value="Save">Save</button>
