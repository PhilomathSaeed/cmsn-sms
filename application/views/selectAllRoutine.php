            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> Select Class For Class Routine
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" action="index.php?module=examination&view=routinView" method="POST">
                            <div class="form-body">
                            ...
                            <div class="form-actions fluid">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn blue" name="submit" type="submit" value="View Routine">View Routine</button>
